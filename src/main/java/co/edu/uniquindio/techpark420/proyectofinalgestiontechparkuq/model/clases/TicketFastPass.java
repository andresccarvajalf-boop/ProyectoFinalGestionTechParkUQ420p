...
public class TicketFastPass extends Ticket {
    ...
    public boolean validarFastPass(Atraccion atraccion) {
        ...
        return atraccionesHabilitadas.contains(atraccion)
                && atraccion.getEstado() != null;
    }
    ...
    public boolean isPrioridadCola() {
        return prioridadCola;
    }

    public List<Atraccion> getAtraccionesHabilitadas() {
        return atraccionesHabilitadas;
    }
